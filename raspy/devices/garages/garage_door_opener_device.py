"""This module contains the GarageDoorOpenerDevice type."""


from raspy.devices.access.opener_device import OpenerDevice
from raspy.devices.garages.garage_door_opener import GarageDoorOpener


class GarageDoorOpenerDevice(GarageDoorOpener):
    ...
    def __init__(self, relay, door_sensor, open_state, lock):
        ...
        """
        GarageDoorOpener.__init__(self)
