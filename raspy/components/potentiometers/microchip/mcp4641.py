"""This module contains the MCP4641 type."""
...
class MCP4641(mcp.MicrochipPotentiometer):
    """Hardware device abstraction component for the Microchip 4641."""

    def __int__(self, device=None, pin_a0=False, pin_a1=False, pin_a2=False,
                channel=microchip_pot_channel.NONE,
                non_vol_mode=mode.VOLATILE_AND_NON_VOLATILE):
        """Initialize a new instance of the MCP4641.
