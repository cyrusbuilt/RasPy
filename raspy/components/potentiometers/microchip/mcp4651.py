"""This module contains the MCP4651 type."""
...
class MCP4651(mcp.MicrochipPotentiometer):
    """Hardware device abstraction component for the Microchip 4651."""

    def __init__(self, device=None, pin_a0=False, pin_a1=False, pin_a2=False,
                 channel=microchip_pot_channel.NONE, init_val=0):
        """Initialize a new instance of the MCP4651.
        ...
        :param int init_val: The initial value.
        ...
        I2C bus.
        """
        mcp.MicrochipPotentiometer.__init__(self, device, pin_a0, pin_a1, pin_a2,
                                            channel, mode.VOLATILE_ONLY,
                                            init_val)
