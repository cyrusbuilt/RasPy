"""This module contains the MCP4452 type."""
...
class MCP4452(mcp.MicrochipPotentiometer):
    """Hardware device abstraction component for the Microchip 4452."""

    def __init__(self, device=None, pin_a0=False, init_val=0):
        """Initialize a new instance of the MCP4452.
