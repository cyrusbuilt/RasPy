"""This module contains the MCP4642 type."""
...
class MCP4642(mcp.MicrochipPotentiometer):
    """Hardware device abstraction component for the MCP4642 type."""
    ...
    def __init__(self, device=None, pin_a0=False, pin_a1=False,
        ...
        """Initialize a new instance of the MCP4642.
