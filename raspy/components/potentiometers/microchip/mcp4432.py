""""This module contains the MCP4432 type."""
...
class MCP4432(mcp.MicrochipPotentiometer):
    """Hardware device abstraction component for the Microchip MCP4432."""

    def __init__(self, device=None, pin_a0=False, init_val=0):
        """Initialize a new instance of the MCP4432.
