"""This module contains the MCP4442 type."""
...
class MCP4442(mcp.MicrochipPotentiometer):
    """Hardware device abstraction componnent for the Microchip MCP4442."""

    def __init__(self, device=None, pin_a0=False, init_val=0):
        """Initialize a new instance of the MCP4442.
