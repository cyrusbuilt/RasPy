"""This module contains the MCP4462 type."""
...
class MCP4462(mcp.MicrochipPotentiometer):
    """Hardware abstraction component for the MCP4462 type."""

    def __init__(self, device=None, pin_a0=False, init_val=0):
        """Initialize a new instance of MCP4462.
