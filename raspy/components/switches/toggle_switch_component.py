"""This module contains the ToggleSwitchComponent type."""
...
from raspy.components.switches.toggle_switch import ToggleSwitch
...
class ToggleSwitchComponent(ToggleSwitch):
    """A component that is an abstraction of a toggle switch."""

    def __init__(self, pin):
        """Initialize a new instance of ToggleSwitchComponent.

        :param gpio.Gpio pin: The input pin the switch is attached to.
        :raises: ArgumentNullException if pin is None.
        """
        ToggleSwitch.__init__(self)
        if pin is None:
    ...
    def poll(self):
        ...
        self.__pollThread.name = "ToggleSwitchComponentPollThread"
